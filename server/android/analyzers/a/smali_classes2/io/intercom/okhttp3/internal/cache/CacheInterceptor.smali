...
.method private cacheWritingResponse(Lio/intercom/okhttp3/internal/cache/CacheRequest;Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/Response;
    ...
    .line 162
    :cond_0
    invoke-interface {p1}, Lio/intercom/okhttp3/internal/cache/CacheRequest;->body()Lio/intercom/a/r;
    ...
    invoke-direct {v2, p0, v1, p1, v0}, Lio/intercom/okhttp3/internal/cache/CacheInterceptor$1;-><init>(Lio/intercom/okhttp3/internal/cache/CacheInterceptor;Lio/intercom/a/e;Lio/intercom/okhttp3/internal/cache/CacheRequest;Lio/intercom/a/d;)V

    const-string p1, "Content-Type"

    .line 210
    invoke-virtual {p2, p1}, Lio/intercom/okhttp3/Response;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v3, p1, v0, v1, v2}, Lio/intercom/okhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLio/intercom/a/e;)V

    invoke-virtual {p2, v3}, Lio/intercom/okhttp3/Response$Builder;->body(Lio/intercom/okhttp3/ResponseBody;)Lio/intercom/okhttp3/Response$Builder;
...
.method private static combine(Lio/intercom/okhttp3/Headers;Lio/intercom/okhttp3/Headers;)Lio/intercom/okhttp3/Headers;
    ...
    .line 222
    invoke-virtual {p0, v3}, Lio/intercom/okhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v4

    .line 223
    invoke-virtual {p0, v3}, Lio/intercom/okhttp3/Headers;->value(I)Ljava/lang/String;
    ...
    invoke-virtual {v6, v0, v4, v5}, Lio/intercom/okhttp3/internal/Internal;->addLenient(Lio/intercom/okhttp3/Headers$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 233
    invoke-virtual {p1, v2}, Lio/intercom/okhttp3/Headers;->name(I)Ljava/lang/String;
    ...
    .line 237
    :cond_4
    invoke-static {v1}, Lio/intercom/okhttp3/internal/cache/CacheInterceptor;->isEndToEnd(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v2}, Lio/intercom/okhttp3/Headers;->value(I)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v0, v1, v4}, Lio/intercom/okhttp3/internal/Internal;->addLenient(Lio/intercom/okhttp3/Headers$Builder;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static stripBody(Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/Response;
    ...
    invoke-virtual {p0, v0}, Lio/intercom/okhttp3/Response$Builder;->body(Lio/intercom/okhttp3/ResponseBody;)Lio/intercom/okhttp3/Response$Builder;
...
.method public intercept(Lio/intercom/okhttp3/Interceptor$Chain;)Lio/intercom/okhttp3/Response;
    ...
    .line 59
    new-instance v3, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;

    invoke-interface {p1}, Lio/intercom/okhttp3/Interceptor$Chain;->request()Lio/intercom/okhttp3/Request;

    move-result-object v4

    invoke-direct {v3, v1, v2, v4, v0}, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;-><init>(JLio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)V

    invoke-virtual {v3}, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->get()Lio/intercom/okhttp3/internal/cache/CacheStrategy;
    ...
    invoke-virtual {v0, p1}, Lio/intercom/okhttp3/Response$Builder;->request(Lio/intercom/okhttp3/Request;)Lio/intercom/okhttp3/Response$Builder;
    ...
    .line 75
    invoke-virtual {p1, v0}, Lio/intercom/okhttp3/Response$Builder;->protocol(Lio/intercom/okhttp3/Protocol;)Lio/intercom/okhttp3/Response$Builder;
    ...
    .line 76
    invoke-virtual {p1, v0}, Lio/intercom/okhttp3/Response$Builder;->code(I)Lio/intercom/okhttp3/Response$Builder;
    ...
    .line 77
    invoke-virtual {p1, v0}, Lio/intercom/okhttp3/Response$Builder;->message(Ljava/lang/String;)Lio/intercom/okhttp3/Response$Builder;

    move-result-object p1

    sget-object v0, Lio/intercom/okhttp3/internal/Util;->EMPTY_RESPONSE:Lio/intercom/okhttp3/ResponseBody;

    .line 78
    invoke-virtual {p1, v0}, Lio/intercom/okhttp3/Response$Builder;->body(Lio/intercom/okhttp3/ResponseBody;)Lio/intercom/okhttp3/Response$Builder;
    ...
    invoke-virtual {p1, v0}, Lio/intercom/okhttp3/Response$Builder;->cacheResponse(Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/Response$Builder;
    ...
    invoke-static {v1, v2}, Lio/intercom/okhttp3/internal/cache/CacheInterceptor;->combine(Lio/intercom/okhttp3/Headers;Lio/intercom/okhttp3/Headers;)Lio/intercom/okhttp3/Headers;
    ...
    invoke-virtual {v0, v1, v2}, Lio/intercom/okhttp3/Response$Builder;->sentRequestAtMillis(J)Lio/intercom/okhttp3/Response$Builder;
    ...
    invoke-virtual {v0, v1, v2}, Lio/intercom/okhttp3/Response$Builder;->receivedResponseAtMillis(J)Lio/intercom/okhttp3/Response$Builder;
    ...
    .line 109
    invoke-static {p1}, Lio/intercom/okhttp3/internal/cache/CacheInterceptor;->stripBody(Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/Response;
    ...
    .line 115
    iget-object p1, p0, Lio/intercom/okhttp3/internal/cache/CacheInterceptor;->cache:Lio/intercom/okhttp3/internal/cache/InternalCache;

    invoke-interface {p1}, Lio/intercom/okhttp3/internal/cache/InternalCache;->trackConditionalCacheHit()V

    .line 116
    iget-object p1, p0, Lio/intercom/okhttp3/internal/cache/CacheInterceptor;->cache:Lio/intercom/okhttp3/internal/cache/InternalCache;

    invoke-interface {p1, v3, v0}, Lio/intercom/okhttp3/internal/cache/InternalCache;->update(Lio/intercom/okhttp3/Response;Lio/intercom/okhttp3/Response;)V
    ...
    invoke-virtual {v0, p1}, Lio/intercom/okhttp3/Response$Builder;->networkResponse(Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/Response$Builder;
    ...
    invoke-static {p1, v2}, Lio/intercom/okhttp3/internal/cache/CacheStrategy;->isCacheable(Lio/intercom/okhttp3/Response;Lio/intercom/okhttp3/Request;)Z
    ...
    invoke-interface {v0, p1}, Lio/intercom/okhttp3/internal/cache/InternalCache;->put(Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/internal/cache/CacheRequest;

    move-result-object v0

    .line 132
    invoke-direct {p0, v0, p1}, Lio/intercom/okhttp3/internal/cache/CacheInterceptor;->cacheWritingResponse(Lio/intercom/okhttp3/internal/cache/CacheRequest;Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/Response;
    ...
    invoke-static {v0}, Lio/intercom/okhttp3/internal/http/HttpMethod;->invalidatesCache(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, v2}, Lio/intercom/okhttp3/internal/cache/InternalCache;->remove(Lio/intercom/okhttp3/Request;)V
    :try_end_1
