...
.method public onFailure(Lio/intercom/okhttp3/Call;Ljava/io/IOException;)V
    ...
    .line 211
    iget-object p1, p0, Lio/intercom/okhttp3/internal/ws/RealWebSocket$2;->this$0:Lio/intercom/okhttp3/internal/ws/RealWebSocket;

    const/4 v0, 0x0

    invoke-virtual {p1, p2, v0}, Lio/intercom/okhttp3/internal/ws/RealWebSocket;->failWebSocket(Ljava/lang/Exception;Lio/intercom/okhttp3/Response;)V
...
.method public onResponse(Lio/intercom/okhttp3/Call;Lio/intercom/okhttp3/Response;)V
    ...
    .line 195
    invoke-virtual {p1}, Lio/intercom/okhttp3/internal/connection/StreamAllocation;->noNewStreams()V

    .line 196
    invoke-virtual {p1}, Lio/intercom/okhttp3/internal/connection/StreamAllocation;->connection()Lio/intercom/okhttp3/internal/connection/RealConnection;

    move-result-object v0

    invoke-virtual {v0, p1}, Lio/intercom/okhttp3/internal/connection/RealConnection;->newWebSocketStreams(Lio/intercom/okhttp3/internal/connection/StreamAllocation;)Lio/intercom/okhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v1, v1, Lio/intercom/okhttp3/internal/ws/RealWebSocket;->listener:Lio/intercom/okhttp3/WebSocketListener;

    iget-object v2, p0, Lio/intercom/okhttp3/internal/ws/RealWebSocket$2;->this$0:Lio/intercom/okhttp3/internal/ws/RealWebSocket;

    invoke-virtual {v1, v2, p2}, Lio/intercom/okhttp3/WebSocketListener;->onOpen(Lio/intercom/okhttp3/WebSocket;Lio/intercom/okhttp3/Response;)V
    ...
    iget-object v1, p0, Lio/intercom/okhttp3/internal/ws/RealWebSocket$2;->val$request:Lio/intercom/okhttp3/Request;

    invoke-virtual {v1}, Lio/intercom/okhttp3/Request;->url()Lio/intercom/okhttp3/HttpUrl;

    move-result-object v1

    invoke-virtual {v1}, Lio/intercom/okhttp3/HttpUrl;->redact()Ljava/lang/String;
    ...
    iget v2, p0, Lio/intercom/okhttp3/internal/ws/RealWebSocket$2;->val$pingIntervalMillis:I

    int-to-long v2, v2

    invoke-virtual {v1, p2, v2, v3, v0}, Lio/intercom/okhttp3/internal/ws/RealWebSocket;->initReaderAndWriter(Ljava/lang/String;JLio/intercom/okhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    invoke-virtual {p1}, Lio/intercom/okhttp3/internal/ws/RealWebSocket;->loopReader()V
    :try_end_1
    ...
    .line 206
    iget-object p2, p0, Lio/intercom/okhttp3/internal/ws/RealWebSocket$2;->this$0:Lio/intercom/okhttp3/internal/ws/RealWebSocket;

    const/4 v0, 0x0

    invoke-virtual {p2, p1, v0}, Lio/intercom/okhttp3/internal/ws/RealWebSocket;->failWebSocket(Ljava/lang/Exception;Lio/intercom/okhttp3/Response;)V
    ...
    invoke-virtual {v0, p1, p2}, Lio/intercom/okhttp3/internal/ws/RealWebSocket;->failWebSocket(Ljava/lang/Exception;Lio/intercom/okhttp3/Response;)V
