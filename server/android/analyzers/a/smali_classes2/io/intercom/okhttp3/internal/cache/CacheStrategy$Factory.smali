...
.method public constructor <init>(JLio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)V
    ...
    .line 138
    iput v0, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->ageSeconds:I
    ...
    iput-wide p1, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->sentRequestMillis:J
    ...
    iput-wide p1, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->receivedResponseMillis:J
    ...
    .line 153
    invoke-static {v1}, Lio/intercom/okhttp3/internal/http/HttpDate;->parse(Ljava/lang/String;)Ljava/util/Date;

    move-result-object p4

    iput-object p4, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->servedDate:Ljava/util/Date;

    .line 154
    iput-object v1, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->servedDateString:Ljava/lang/String;
    ...
    iput-object p4, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->expires:Ljava/util/Date;
    ...
    iput-object p4, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->lastModified:Ljava/util/Date;

    .line 159
    iput-object v1, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->lastModifiedString:Ljava/lang/String;
    ...
    .line 161
    iput-object v1, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->etag:Ljava/lang/String;
    ...
    .line 163
    invoke-static {v1, v0}, Lio/intercom/okhttp3/internal/http/HttpHeaders;->parseSeconds(Ljava/lang/String;I)I

    move-result p4

    iput p4, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->ageSeconds:I
...
.method private cacheResponseAge()J
    ...
    .line 302
    iget-wide v3, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->receivedResponseMillis:J
    ...
    .line 304
    :cond_0
    iget v0, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->ageSeconds:I
    ...
    iget-wide v5, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->sentRequestMillis:J

    sub-long v5, v3, v5

    .line 308
    iget-wide v7, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->nowMillis:J
...
.method private computeFreshnessLifetime()J
    ...
    .line 289
    :cond_4
    iget-wide v3, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->sentRequestMillis:J
...
.method private getCandidate()Lio/intercom/okhttp3/internal/cache/CacheStrategy;
    ...
    invoke-direct {v0, v2, v1}, Lio/intercom/okhttp3/internal/cache/CacheStrategy;-><init>(Lio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)V
    ...
    .line 203
    invoke-virtual {v0}, Lio/intercom/okhttp3/CacheControl;->noCache()Z
    ...
    invoke-static {v2}, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->hasConditions(Lio/intercom/okhttp3/Request;)Z
    ...
    invoke-virtual {v2}, Lio/intercom/okhttp3/Response;->cacheControl()Lio/intercom/okhttp3/CacheControl;

    move-result-object v2

    .line 208
    invoke-virtual {v2}, Lio/intercom/okhttp3/CacheControl;->immutable()Z
    ...
    .line 220
    :cond_5
    invoke-virtual {v0}, Lio/intercom/okhttp3/CacheControl;->minFreshSeconds()I
    ...
    .line 225
    :goto_0
    invoke-virtual {v2}, Lio/intercom/okhttp3/CacheControl;->mustRevalidate()Z

    move-result v7

    if-nez v7, :cond_7

    invoke-virtual {v0}, Lio/intercom/okhttp3/CacheControl;->maxStaleSeconds()I
    ...
    .line 229
    :cond_7
    invoke-virtual {v2}, Lio/intercom/okhttp3/CacheControl;->noCache()Z
    ...
    .line 232
    invoke-virtual {v0, v2, v5}, Lio/intercom/okhttp3/Response$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lio/intercom/okhttp3/Response$Builder;
    ...
    .line 236
    invoke-virtual {v0, v2, v3}, Lio/intercom/okhttp3/Response$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lio/intercom/okhttp3/Response$Builder;

    .line 238
    :cond_9
    new-instance v2, Lio/intercom/okhttp3/internal/cache/CacheStrategy;

    invoke-virtual {v0}, Lio/intercom/okhttp3/Response$Builder;->build()Lio/intercom/okhttp3/Response;

    move-result-object v0

    invoke-direct {v2, v1, v0}, Lio/intercom/okhttp3/internal/cache/CacheStrategy;-><init>(Lio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)V
    ...
    .line 264
    new-instance v1, Lio/intercom/okhttp3/internal/cache/CacheStrategy;

    iget-object v2, p0, Lio/intercom/okhttp3/internal/cache/CacheStrategy$Factory;->cacheResponse:Lio/intercom/okhttp3/Response;

    invoke-direct {v1, v0, v2}, Lio/intercom/okhttp3/internal/cache/CacheStrategy;-><init>(Lio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)V
...
.method public get()Lio/intercom/okhttp3/internal/cache/CacheStrategy;
    ...
    invoke-direct {v0, v1, v1}, Lio/intercom/okhttp3/internal/cache/CacheStrategy;-><init>(Lio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)V
