.class public Lorg/apache/http/impl/execchain/f;
...
.field private final b:Lorg/apache/http/protocol/HttpProcessor;


# direct methods
.method public constructor <init>(Lorg/apache/http/impl/execchain/b;Lorg/apache/http/protocol/HttpProcessor;)V
    .locals 1
    ...
    .line 83
    iput-object p1, p0, Lorg/apache/http/impl/execchain/f;->a:Lorg/apache/http/impl/execchain/b;

    .line 84
    iput-object p2, p0, Lorg/apache/http/impl/execchain/f;->b:Lorg/apache/http/protocol/HttpProcessor;
...
.method public a(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/client/methods/n;Lorg/apache/http/client/d/a;Lorg/apache/http/client/methods/f;)Lorg/apache/http/client/methods/b;
    ...
    .line 142
    :goto_0
    invoke-virtual {p2, v0}, Lorg/apache/http/client/methods/n;->a(Ljava/net/URI;)V

    .line 145
    invoke-virtual {p0, p2, p1}, Lorg/apache/http/impl/execchain/f;->a(Lorg/apache/http/client/methods/n;Lorg/apache/http/conn/routing/HttpRoute;)V

    .line 147
    invoke-virtual {p2}, Lorg/apache/http/client/methods/n;->getParams()Lorg/apache/http/params/HttpParams;
    ...
    .line 177
    invoke-virtual {p3}, Lorg/apache/http/client/d/a;->i()Lorg/apache/http/client/CredentialsProvider;
    ...
    .line 180
    invoke-virtual {p3, v1}, Lorg/apache/http/client/d/a;->a(Lorg/apache/http/client/CredentialsProvider;)V
    ...
    .line 189
    invoke-virtual {p3, v0, v3}, Lorg/apache/http/client/d/a;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    const-string v0, "http.route"

    .line 190
    invoke-virtual {p3, v0, p1}, Lorg/apache/http/client/d/a;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    const-string v0, "http.request"

    .line 191
    invoke-virtual {p3, v0, p2}, Lorg/apache/http/client/d/a;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    .line 193
    iget-object v0, p0, Lorg/apache/http/impl/execchain/f;->b:Lorg/apache/http/protocol/HttpProcessor;
    ...
    .line 195
    iget-object v0, p0, Lorg/apache/http/impl/execchain/f;->a:Lorg/apache/http/impl/execchain/b;
    ...
    .line 199
    invoke-virtual {p3, p2, p1}, Lorg/apache/http/client/d/a;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    .line 200
    iget-object p2, p0, Lorg/apache/http/impl/execchain/f;->b:Lorg/apache/http/protocol/HttpProcessor;
    ...
    .line 209
    invoke-interface {p1}, Lorg/apache/http/client/methods/b;->close()V
...
.method a(Lorg/apache/http/client/methods/n;Lorg/apache/http/conn/routing/HttpRoute;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 91
    :try_start_0
    invoke-virtual {p1}, Lorg/apache/http/client/methods/n;->getURI()Ljava/net/URI;
    ...
    .line 97
    invoke-static {v0, p2, v2}, Lorg/apache/http/client/e/d;->a(Ljava/net/URI;Lorg/apache/http/HttpHost;Z)Ljava/net/URI;
    ...
    .line 99
    :cond_0
    invoke-static {v0}, Lorg/apache/http/client/e/d;->a(Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 109
    :goto_0
    invoke-virtual {p1, p2}, Lorg/apache/http/client/methods/n;->a(Ljava/net/URI;)V
    :try_end_0
    ...
    invoke-virtual {p1}, Lorg/apache/http/client/methods/n;->getRequestLine()Lorg/apache/http/RequestLine;
