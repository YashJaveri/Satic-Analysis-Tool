.class public Lorg/apache/http/message/c;
...
# static fields
.field public static final a:Lorg/apache/http/message/c;
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field

.field public static final b:Lorg/apache/http/message/c;
...
.method static constructor <clinit>()V
    ...
    .line 63
    new-instance v0, Lorg/apache/http/message/c;

    invoke-direct {v0}, Lorg/apache/http/message/c;-><init>()V

    sput-object v0, Lorg/apache/http/message/c;->a:Lorg/apache/http/message/c;
    ...
    sput-object v0, Lorg/apache/http/message/c;->b:Lorg/apache/http/message/c;
...
.method protected a(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/RequestLine;)V
    ...
    invoke-virtual {p0, v3}, Lorg/apache/http/message/c;->a(Lorg/apache/http/ProtocolVersion;)I
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/http/message/c;->appendProtocolVersion(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/ProtocolVersion;)Lorg/apache/http/util/CharArrayBuffer;
...
.method protected a(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/StatusLine;)V
    ...
    invoke-virtual {p0, v0}, Lorg/apache/http/message/c;->a(Lorg/apache/http/ProtocolVersion;)I
    ...
    invoke-virtual {p0, p1, v0}, Lorg/apache/http/message/c;->appendProtocolVersion(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/ProtocolVersion;)Lorg/apache/http/util/CharArrayBuffer;
...
.method public appendProtocolVersion(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/ProtocolVersion;)Lorg/apache/http/util/CharArrayBuffer;
    ...
    .line 114
    invoke-virtual {p0, p2}, Lorg/apache/http/message/c;->a(Lorg/apache/http/ProtocolVersion;)I
...
.method public formatHeader(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/Header;)Lorg/apache/http/util/CharArrayBuffer;
    ...
    .line 284
    :cond_0
    invoke-virtual {p0, p1}, Lorg/apache/http/message/c;->a(Lorg/apache/http/util/CharArrayBuffer;)Lorg/apache/http/util/CharArrayBuffer;

    move-result-object p1

    .line 285
    invoke-virtual {p0, p1, p2}, Lorg/apache/http/message/c;->a(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/Header;)V
...
.method public formatRequestLine(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/RequestLine;)Lorg/apache/http/util/CharArrayBuffer;
    ...
    .line 167
    invoke-virtual {p0, p1, p2}, Lorg/apache/http/message/c;->a(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/RequestLine;)V
...
.method public formatStatusLine(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/StatusLine;)Lorg/apache/http/util/CharArrayBuffer;
    ...
    .line 222
    invoke-virtual {p0, p1, p2}, Lorg/apache/http/message/c;->a(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/StatusLine;)V
