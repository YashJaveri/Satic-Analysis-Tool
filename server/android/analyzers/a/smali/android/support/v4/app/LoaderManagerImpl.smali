...
.method constructor <init>(Landroid/arch/lifecycle/h;Landroid/arch/lifecycle/u;)V
    ...
    .param p1    # Landroid/arch/lifecycle/h;
        ...
        .end annotation
    .end param
    .param p2    # Landroid/arch/lifecycle/u;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 373
    invoke-static {p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;->getInstance(Landroid/arch/lifecycle/u;)Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;
...
.method private createAndInstallLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;Landroid/support/v4/content/Loader;)Landroid/support/v4/content/Loader;
    ...
    .line 400
    iget-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLifecycleOwner:Landroid/arch/lifecycle/h;

    invoke-virtual {v1, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->setCallback(Landroid/arch/lifecycle/h;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
...
.method public initLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
    ...
    invoke-virtual {v0, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->setCallback(Landroid/arch/lifecycle/h;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
