...
.method protected constructor <init>(Lorg/codehaus/jackson/map/MapperConfig;ZLorg/codehaus/jackson/type/JavaType;Lorg/codehaus/jackson/map/introspect/AnnotatedClass;)V
    ...
    iput-object v0, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_properties:Ljava/util/LinkedHashMap;
    ...
    iget-object p1, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_config:Lorg/codehaus/jackson/map/MapperConfig;
    ...
    .line 110
    iget-object p1, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_annotationIntrospector:Lorg/codehaus/jackson/map/AnnotationIntrospector;
    ...
    invoke-virtual {p1}, Lorg/codehaus/jackson/map/MapperConfig;->getDefaultVisibilityChecker()Lorg/codehaus/jackson/map/introspect/VisibilityChecker;

    move-result-object p1

    iput-object p1, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_visibilityChecker:Lorg/codehaus/jackson/map/introspect/VisibilityChecker;

    goto :goto_0

    .line 113
    :cond_1
    iget-object p2, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_config:Lorg/codehaus/jackson/map/MapperConfig;

    invoke-virtual {p2}, Lorg/codehaus/jackson/map/MapperConfig;->getDefaultVisibilityChecker()Lorg/codehaus/jackson/map/introspect/VisibilityChecker;

    move-result-object p2

    invoke-virtual {p1, p4, p2}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->findAutoDetectVisibility(Lorg/codehaus/jackson/map/introspect/AnnotatedClass;Lorg/codehaus/jackson/map/introspect/VisibilityChecker;)Lorg/codehaus/jackson/map/introspect/VisibilityChecker;
...
.method private _addIgnored(Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;)V
    ...
    .line 601
    iget-object p1, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_ignoredPropertyNamesForDeser:Ljava/util/Set;

    invoke-direct {p0, p1, v0}, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->addToSet(Ljava/util/Set;Ljava/lang/String;)Ljava/util/Set;

    move-result-object p1

    iput-object p1, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_ignoredPropertyNamesForDeser:Ljava/util/Set;
...
.method protected _addCreators()V
    ...
    .line 377
    :cond_0
    iget-object v1, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_classDef:Lorg/codehaus/jackson/map/introspect/AnnotatedClass;

    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/AnnotatedClass;->getConstructors()Ljava/util/List;
    ...
    check-cast v2, Lorg/codehaus/jackson/map/introspect/AnnotatedConstructor;

    .line 378
    iget-object v5, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_creatorProperties:Ljava/util/LinkedList;
    ...
    iput-object v5, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_creatorProperties:Ljava/util/LinkedList;

    .line 381
    :cond_2
    invoke-virtual {v2}, Lorg/codehaus/jackson/map/introspect/AnnotatedConstructor;->getParameterCount()I
    ...
    .line 382
    invoke-virtual {v2, v6}, Lorg/codehaus/jackson/map/introspect/AnnotatedConstructor;->getParameter(I)Lorg/codehaus/jackson/map/introspect/AnnotatedParameter;
    ...
    .line 387
    invoke-virtual {p0, v8}, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_property(Ljava/lang/String;)Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;

    move-result-object v9

    .line 388
    invoke-virtual {v9, v7, v8, v3, v4}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->addCtor(Lorg/codehaus/jackson/map/introspect/AnnotatedParameter;Ljava/lang/String;ZZ)V

    .line 389
    iget-object v7, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_creatorProperties:Ljava/util/LinkedList;
    ...
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/AnnotatedClass;->getStaticMethods()Ljava/util/List;
    ...
    .line 398
    invoke-virtual {v2, v6}, Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;->getParameter(I)Lorg/codehaus/jackson/map/introspect/AnnotatedParameter;
...
.method protected _addFields()V
    ...
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/AnnotatedClass;->fields()Ljava/lang/Iterable;
    ...
    .line 343
    :cond_0
    iget-boolean v4, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_forSerialization:Z
    ...
    .line 359
    iget-object v7, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_visibilityChecker:Lorg/codehaus/jackson/map/introspect/VisibilityChecker;

    invoke-interface {v7, v2}, Lorg/codehaus/jackson/map/introspect/VisibilityChecker;->isFieldVisible(Lorg/codehaus/jackson/map/introspect/AnnotatedField;)Z
    ...
    .line 363
    :goto_3
    invoke-virtual {p0, v3}, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_property(Ljava/lang/String;)Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;

    move-result-object v3

    invoke-virtual {v3, v2, v4, v7, v5}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->addField(Lorg/codehaus/jackson/map/introspect/AnnotatedField;Ljava/lang/String;ZZ)V
...
.method protected _addInjectables()V
    ...
    invoke-virtual {p0, v3, v2}, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_doAddInjectable(Ljava/lang/Object;Lorg/codehaus/jackson/map/introspect/AnnotatedMember;)V
...
.method protected _addMethods()V
    ...
    .line 433
    invoke-virtual {v0, v2}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->hasAnyGetterAnnotation(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Z
    ...
    .line 434
    iget-object v3, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_anyGetters:Ljava/util/LinkedList;
    ...
    iput-object v3, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_anyGetters:Ljava/util/LinkedList;
    ...
    .line 441
    :cond_2
    invoke-virtual {v0, v2}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->hasAsValueAnnotation(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Z
    ...
    .line 442
    iget-object v3, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_jsonValueGetters:Ljava/util/LinkedList;
    ...
    iput-object v3, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_jsonValueGetters:Ljava/util/LinkedList;
    ...
    .line 450
    :cond_5
    invoke-virtual {v0, v2}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->findGettablePropertyName(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lorg/codehaus/jackson/map/util/BeanUtil;->okNameForRegularGetter(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lorg/codehaus/jackson/map/util/BeanUtil;->okNameForIsGetter(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 458
    :cond_6
    iget-object v6, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_visibilityChecker:Lorg/codehaus/jackson/map/introspect/VisibilityChecker;

    invoke-interface {v6, v2}, Lorg/codehaus/jackson/map/introspect/VisibilityChecker;->isIsGetterVisible(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Z
    ...
    invoke-interface {v6, v2}, Lorg/codehaus/jackson/map/introspect/VisibilityChecker;->isGetterVisible(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Z
    ...
    .line 464
    :cond_8
    invoke-static {v2}, Lorg/codehaus/jackson/map/util/BeanUtil;->okNameForGetter(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v2, v5, v6, v4}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->addGetter(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;Ljava/lang/String;ZZ)V
    ...
    .line 477
    :cond_d
    invoke-virtual {v0, v2}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->findSettablePropertyName(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Ljava/lang/String;
    ...
    .line 479
    invoke-static {v2}, Lorg/codehaus/jackson/map/util/BeanUtil;->okNameForSetter(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Ljava/lang/String;
    ...
    invoke-interface {v6, v2}, Lorg/codehaus/jackson/map/introspect/VisibilityChecker;->isSetterVisible(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Z
    ...
    invoke-virtual {v3, v2, v5, v6, v4}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->addSetter(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;Ljava/lang/String;ZZ)V
    ...
    .line 500
    invoke-virtual {v0, v2}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->hasAnySetterAnnotation(Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;)Z
    ...
    .line 501
    iget-object v3, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_anySetters:Ljava/util/LinkedList;
    ...
    iput-object v3, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_anySetters:Ljava/util/LinkedList;
...
.method protected _doAddInjectable(Ljava/lang/Object;Lorg/codehaus/jackson/map/introspect/AnnotatedMember;)V
    ...
    check-cast p2, Lorg/codehaus/jackson/map/introspect/AnnotatedMember;
...
.method protected _removeUnwantedProperties()V
    ...
    .line 567
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->anyVisible()Z
    ...
    .line 572
    :cond_0
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->anyIgnorals()Z
    ...
    .line 573
    invoke-direct {p0, v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_addIgnored(Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;)V

    .line 575
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->anyExplicitNames()Z
    ...
    .line 580
    :cond_1
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->removeIgnored()V

    .line 583
    :cond_2
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->removeNonVisible()V
...
.method protected _renameProperties()V
    ...
    .line 619
    invoke-virtual {v2}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->findNewName()Ljava/lang/String;
    ...
    .line 624
    :cond_1
    invoke-virtual {v2, v3}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->withName(Ljava/lang/String;)Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;
    ...
    check-cast v3, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;
    ...
    .line 638
    :cond_3
    invoke-virtual {v3, v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->addAll(Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;)V
...
.method protected _renameUsing(Lorg/codehaus/jackson/map/PropertyNamingStrategy;)V
    ...
    invoke-virtual {p1, v5, v6, v4}, Lorg/codehaus/jackson/map/PropertyNamingStrategy;->nameForGetterMethod(Lorg/codehaus/jackson/map/MapperConfig;Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v5, v6, v4}, Lorg/codehaus/jackson/map/PropertyNamingStrategy;->nameForField(Lorg/codehaus/jackson/map/MapperConfig;Lorg/codehaus/jackson/map/introspect/AnnotatedField;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v5, v6, v4}, Lorg/codehaus/jackson/map/PropertyNamingStrategy;->nameForSetterMethod(Lorg/codehaus/jackson/map/MapperConfig;Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v5, v6, v4}, Lorg/codehaus/jackson/map/PropertyNamingStrategy;->nameForConstructorParameter(Lorg/codehaus/jackson/map/MapperConfig;Lorg/codehaus/jackson/map/introspect/AnnotatedParameter;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 671
    invoke-virtual {v3, v4}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->withName(Ljava/lang/String;)Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;
    ...
    .line 680
    :cond_7
    invoke-virtual {v5, v3}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->addAll(Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;)V
...
.method protected _sortProperties()V
    ...
    invoke-virtual {v0, v1}, Lorg/codehaus/jackson/map/AnnotationIntrospector;->findSerializationSortAlphabetically(Lorg/codehaus/jackson/map/introspect/AnnotatedClass;)Ljava/lang/Boolean;
    ...
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/MapperConfig;->shouldSortPropertiesAlphabetically()Z
    ...
    .line 276
    iget-object v2, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_creatorProperties:Ljava/util/LinkedList;
    ...
    .line 279
    :cond_1
    iget-object v2, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_properties:Ljava/util/LinkedHashMap;
    ...
    .line 289
    invoke-virtual {v4}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->getName()Ljava/lang/String;
    ...
    check-cast v8, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;

    .line 298
    invoke-virtual {v8}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->getInternalName()Ljava/lang/String;
    ...
    .line 301
    invoke-virtual {v8}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->getName()Ljava/lang/String;
...
.method public collect()Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;
    ...
    .line 239
    invoke-virtual {v1}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->trimByVisibility()V
    ...
    invoke-virtual {v1, v2}, Lorg/codehaus/jackson/map/introspect/POJOPropertyBuilder;->mergeAnnotations(Z)V
...
.method public getAnyGetterMethod()Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;
    ...
    iget-object v2, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_anyGetters:Ljava/util/LinkedList;
...
.method public getAnySetterMethod()Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;
    ...
    iget-object v2, p0, Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;->_anySetters:Ljava/util/LinkedList;
