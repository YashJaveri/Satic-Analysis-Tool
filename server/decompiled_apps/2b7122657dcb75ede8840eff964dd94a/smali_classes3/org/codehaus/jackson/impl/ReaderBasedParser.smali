...
.method private final parseNumberText2(Z)Lorg/codehaus/jackson/JsonToken;
    ...
    .line 835
    iget-object v7, p0, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_textBuffer:Lorg/codehaus/jackson/util/TextBuffer;
    ...
    invoke-virtual {p0, v4}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->getNextChar(Ljava/lang/String;)C
    ...
    .line 884
    invoke-virtual {p0, v4, v1}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->reportUnexpectedNumberChar(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v4}, Lorg/codehaus/jackson/util/TextBuffer;->setCurrentLength(I)V

    .line 894
    invoke-virtual {p0, p1, v0, v9, v2}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->reset(ZIII)Lorg/codehaus/jackson/JsonToken;
...
.method protected _handleInvalidNumberStart(IZ)Lorg/codehaus/jackson/JsonToken;
    ...
    .line 949
    :goto_0
    invoke-virtual {p0, v0, v5}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_matchToken(Ljava/lang/String;I)V
...
.method protected final _handleUnexpectedValue(I)Lorg/codehaus/jackson/JsonToken;
    ...
    .line 1186
    invoke-virtual {p0, p1, v0, v1}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->resetAsNaN(Ljava/lang/String;D)Lorg/codehaus/jackson/JsonToken;
...
.method protected final _matchToken(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_reportInvalidToken(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected final _parseFieldName(I)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, v0, p1, v1}, Lorg/codehaus/jackson/sym/CharsToNameCanonicalizer;->findSymbol([CIII)Ljava/lang/String;
    ...
    .line 1008
    invoke-direct {p0, v2, v1, v0}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_parseFieldName2(III)Ljava/lang/String;
...
.method public getTextCharacters()[C
    ...
    .line 236
    iget-object v3, p0, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_nameCopyBuffer:[C

    if-nez v3, :cond_1

    .line 237
    iget-object v3, p0, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_ioContext:Lorg/codehaus/jackson/io/IOContext;

    invoke-virtual {v3, v2}, Lorg/codehaus/jackson/io/IOContext;->allocNameCopyBuffer(I)[C

    move-result-object v3

    iput-object v3, p0, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_nameCopyBuffer:[C
...
.method protected final parseNumberText(I)Lorg/codehaus/jackson/JsonToken;
    ...
    .line 677
    invoke-virtual {p0, p1, v2}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->_handleInvalidNumberStart(IZ)Lorg/codehaus/jackson/JsonToken;
    ...
    invoke-virtual {p1, v0, v5, v9}, Lorg/codehaus/jackson/util/TextBuffer;->resetWithShared([CII)V

    .line 763
    invoke-virtual {p0, v3, v2, v4, v1}, Lorg/codehaus/jackson/impl/ReaderBasedParser;->reset(ZIII)Lorg/codehaus/jackson/JsonToken;
