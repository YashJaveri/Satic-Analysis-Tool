...
.method public contains(Ljava/lang/Class;)Z
    ...
    .line 123
    :cond_2
    instance-of v3, v1, Lorg/springframework/core/NestedCheckedException;

    if-eqz v3, :cond_3

    .line 124
    check-cast v1, Lorg/springframework/core/NestedCheckedException;

    invoke-virtual {v1, p1}, Lorg/springframework/core/NestedCheckedException;->contains(Ljava/lang/Class;)Z
