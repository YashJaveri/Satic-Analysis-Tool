...
.method private considerNotify(Landroid/arch/lifecycle/LiveData$b;)V
    ...
    .line 109
    iget-object p1, p1, Landroid/arch/lifecycle/LiveData$b;->c:Landroid/arch/lifecycle/n;

    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->mData:Ljava/lang/Object;

    invoke-interface {p1, v0}, Landroid/arch/lifecycle/n;->onChanged(Ljava/lang/Object;)V
...
.method public observeForever(Landroid/arch/lifecycle/n;)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/arch/lifecycle/LiveData$a;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/n;)V
...
.method public removeObservers(Landroid/arch/lifecycle/h;)V
    ...
    invoke-virtual {v2, p1}, Landroid/arch/lifecycle/LiveData$b;->a(Landroid/arch/lifecycle/h;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/arch/lifecycle/LiveData;->removeObserver(Landroid/arch/lifecycle/n;)V
