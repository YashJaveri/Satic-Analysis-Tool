...
public final class Item implements BkJson {
    ...
    public final Item copy(Long l) {
        return new Item(l);
    }

    /* JADX WARNING: Missing block: B:4:0x0010, code skipped:
            if (kotlin.jvm.internal.Intrinsics.areEqual(r1.id, ((com.bankeen.data.remote.apiv2.json.account.Item) r2).id) != false) goto L_0x0015;
     */
