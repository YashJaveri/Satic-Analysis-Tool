...
.method public bridge synthetic clone()Lio/intercom/retrofit2/Call;
    .locals 1
...
.method public clone()Lio/intercom/retrofit2/OkHttpCall;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public enqueue(Lio/intercom/retrofit2/Callback;)V
    ...
    .line 88
    iget-object v1, p0, Lio/intercom/retrofit2/OkHttpCall;->creationFailure:Ljava/lang/Throwable;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-object v2, p0, Lio/intercom/retrofit2/OkHttpCall;->rawCall:Lio/intercom/okhttp3/Call;
    :try_end_1
    ...
    .line 93
    :try_start_2
    iput-object v1, p0, Lio/intercom/retrofit2/OkHttpCall;->creationFailure:Ljava/lang/Throwable;
    ...
    .line 99
    invoke-interface {p1, p0, v1}, Lio/intercom/retrofit2/Callback;->onFailure(Lio/intercom/retrofit2/Call;Ljava/lang/Throwable;)V
    ...
    .line 107
    :cond_2
    new-instance v1, Lio/intercom/retrofit2/OkHttpCall$1;

    invoke-direct {v1, p0, p1}, Lio/intercom/retrofit2/OkHttpCall$1;-><init>(Lio/intercom/retrofit2/OkHttpCall;Lio/intercom/retrofit2/Callback;)V
...
.method public isCanceled()Z
    ...
    invoke-interface {v0}, Lio/intercom/okhttp3/Call;->isCanceled()Z
...
.method parseResponse(Lio/intercom/okhttp3/Response;)Lio/intercom/retrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Lio/intercom/retrofit2/OkHttpCall$NoContentResponseBody;
    ...
    invoke-direct {v1, v2, v3, v4}, Lio/intercom/retrofit2/OkHttpCall$NoContentResponseBody;-><init>(Lio/intercom/okhttp3/MediaType;J)V

    invoke-virtual {p1, v1}, Lio/intercom/okhttp3/Response$Builder;->body(Lio/intercom/okhttp3/ResponseBody;)Lio/intercom/okhttp3/Response$Builder;
    ...
    .line 216
    :cond_1
    new-instance v1, Lio/intercom/retrofit2/OkHttpCall$ExceptionCatchingRequestBody;

    invoke-direct {v1, v0}, Lio/intercom/retrofit2/OkHttpCall$ExceptionCatchingRequestBody;-><init>(Lio/intercom/okhttp3/ResponseBody;)V

    .line 218
    :try_start_0
    iget-object v0, p0, Lio/intercom/retrofit2/OkHttpCall;->serviceMethod:Lio/intercom/retrofit2/ServiceMethod;

    invoke-virtual {v0, v1}, Lio/intercom/retrofit2/ServiceMethod;->toResponse(Lio/intercom/okhttp3/ResponseBody;)Ljava/lang/Object;

    move-result-object v0

    .line 219
    invoke-static {v0, p1}, Lio/intercom/retrofit2/Response;->success(Ljava/lang/Object;Lio/intercom/okhttp3/Response;)Lio/intercom/retrofit2/Response;
    ...
    .line 223
    invoke-virtual {v1}, Lio/intercom/retrofit2/OkHttpCall$ExceptionCatchingRequestBody;->throwIfCaught()V
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lio/intercom/retrofit2/Utils;->buffer(Lio/intercom/okhttp3/ResponseBody;)Lio/intercom/okhttp3/ResponseBody;

    move-result-object v1

    .line 205
    invoke-static {v1, p1}, Lio/intercom/retrofit2/Response;->error(Lio/intercom/okhttp3/ResponseBody;Lio/intercom/okhttp3/Response;)Lio/intercom/retrofit2/Response;
...
.method public declared-synchronized request()Lio/intercom/okhttp3/Request;
    .locals 3
