...
.method constructor <init>(Lio/intercom/okhttp3/Call$Factory;Lio/intercom/okhttp3/HttpUrl;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/Executor;Z)V
    ...
    iput-object p1, p0, Lio/intercom/retrofit2/Retrofit;->converterFactories:Ljava/util/List;
    ...
    iput-object p1, p0, Lio/intercom/retrofit2/Retrofit;->adapterFactories:Ljava/util/List;
...
.method private eagerlyValidateMethods(Ljava/lang/Class;)V
    ...
    .line 157
    invoke-virtual {v0, v3}, Lio/intercom/retrofit2/Platform;->isDefaultMethod(Ljava/lang/reflect/Method;)Z
    ...
    .line 158
    invoke-virtual {p0, v3}, Lio/intercom/retrofit2/Retrofit;->loadServiceMethod(Ljava/lang/reflect/Method;)Lio/intercom/retrofit2/ServiceMethod;
...
# virtual methods
.method public baseUrl()Lio/intercom/okhttp3/HttpUrl;
    .locals 1
...
.method public callAdapter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lio/intercom/retrofit2/CallAdapter;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public callFactory()Lio/intercom/okhttp3/Call$Factory;
    .locals 1
...
.method loadServiceMethod(Ljava/lang/reflect/Method;)Lio/intercom/retrofit2/ServiceMethod;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v1, Lio/intercom/retrofit2/ServiceMethod;

    if-nez v1, :cond_1

    .line 170
    new-instance v1, Lio/intercom/retrofit2/ServiceMethod$Builder;

    invoke-direct {v1, p0, p1}, Lio/intercom/retrofit2/ServiceMethod$Builder;-><init>(Lio/intercom/retrofit2/Retrofit;Ljava/lang/reflect/Method;)V

    invoke-virtual {v1}, Lio/intercom/retrofit2/ServiceMethod$Builder;->build()Lio/intercom/retrofit2/ServiceMethod;
...
.method public newBuilder()Lio/intercom/retrofit2/Retrofit$Builder;
    .locals 1
...
.method public nextCallAdapter(Lio/intercom/retrofit2/CallAdapter$Factory;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lio/intercom/retrofit2/CallAdapter;
    .locals 4
    ...
    .line 220
    iget-object v1, p0, Lio/intercom/retrofit2/Retrofit;->adapterFactories:Ljava/util/List;
    ...
    .line 221
    iget-object v3, p0, Lio/intercom/retrofit2/Retrofit;->adapterFactories:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lio/intercom/retrofit2/CallAdapter$Factory;

    invoke-virtual {v3, p2, p3, p0}, Lio/intercom/retrofit2/CallAdapter$Factory;->get(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Lio/intercom/retrofit2/Retrofit;)Lio/intercom/retrofit2/CallAdapter;
    ...
    iget-object p2, p0, Lio/intercom/retrofit2/Retrofit;->adapterFactories:Ljava/util/List;

    invoke-interface {p2, p1}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lio/intercom/retrofit2/CallAdapter$Factory;
    ...
    .line 238
    iget-object p1, p0, Lio/intercom/retrofit2/Retrofit;->adapterFactories:Ljava/util/List;
...
.method public nextRequestBodyConverter(Lio/intercom/retrofit2/Converter$Factory;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;[Ljava/lang/annotation/Annotation;)Lio/intercom/retrofit2/Converter;
    .locals 4
    ...
    .line 280
    iget-object v3, p0, Lio/intercom/retrofit2/Retrofit;->converterFactories:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lio/intercom/retrofit2/Converter$Factory;

    .line 282
    invoke-virtual {v3, p2, p3, p4, p0}, Lio/intercom/retrofit2/Converter$Factory;->requestBodyConverter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;[Ljava/lang/annotation/Annotation;Lio/intercom/retrofit2/Retrofit;)Lio/intercom/retrofit2/Converter;
    ...
    iget-object p2, p0, Lio/intercom/retrofit2/Retrofit;->converterFactories:Ljava/util/List;

    invoke-interface {p2, p1}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lio/intercom/retrofit2/Converter$Factory;
    ...
    .line 300
    iget-object p1, p0, Lio/intercom/retrofit2/Retrofit;->converterFactories:Ljava/util/List;
...
.method public nextResponseBodyConverter(Lio/intercom/retrofit2/Converter$Factory;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lio/intercom/retrofit2/Converter;
    .locals 4
    .param p1    # Lio/intercom/retrofit2/Converter$Factory;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {v3, p2, p3, p0}, Lio/intercom/retrofit2/Converter$Factory;->responseBodyConverter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Lio/intercom/retrofit2/Retrofit;)Lio/intercom/retrofit2/Converter;
...
.method public requestBodyConverter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;[Ljava/lang/annotation/Annotation;)Lio/intercom/retrofit2/Converter;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public responseBodyConverter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lio/intercom/retrofit2/Converter;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public stringConverter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lio/intercom/retrofit2/Converter;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 363
    iget-object v2, p0, Lio/intercom/retrofit2/Retrofit;->converterFactories:Ljava/util/List;
    ...
    check-cast v2, Lio/intercom/retrofit2/Converter$Factory;

    invoke-virtual {v2, p1, p2, p0}, Lio/intercom/retrofit2/Converter$Factory;->stringConverter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Lio/intercom/retrofit2/Retrofit;)Lio/intercom/retrofit2/Converter;
    ...
    .line 373
    :cond_1
    sget-object p1, Lio/intercom/retrofit2/BuiltInConverters$ToStringConverter;->INSTANCE:Lio/intercom/retrofit2/BuiltInConverters$ToStringConverter;
