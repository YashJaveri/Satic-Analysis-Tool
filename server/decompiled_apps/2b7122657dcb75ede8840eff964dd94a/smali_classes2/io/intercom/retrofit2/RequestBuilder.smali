...
.method constructor <init>(Ljava/lang/String;Lio/intercom/okhttp3/HttpUrl;Ljava/lang/String;Lio/intercom/okhttp3/Headers;Lio/intercom/okhttp3/MediaType;ZZZ)V
    ...
    .line 55
    new-instance p1, Lio/intercom/okhttp3/Request$Builder;

    invoke-direct {p1}, Lio/intercom/okhttp3/Request$Builder;-><init>()V

    iput-object p1, p0, Lio/intercom/retrofit2/RequestBuilder;->requestBuilder:Lio/intercom/okhttp3/Request$Builder;
    ...
    .line 60
    iget-object p1, p0, Lio/intercom/retrofit2/RequestBuilder;->requestBuilder:Lio/intercom/okhttp3/Request$Builder;

    invoke-virtual {p1, p4}, Lio/intercom/okhttp3/Request$Builder;->headers(Lio/intercom/okhttp3/Headers;)Lio/intercom/okhttp3/Request$Builder;

    :cond_0
    if-eqz p7, :cond_1

    .line 65
    new-instance p1, Lio/intercom/okhttp3/FormBody$Builder;

    invoke-direct {p1}, Lio/intercom/okhttp3/FormBody$Builder;-><init>()V

    iput-object p1, p0, Lio/intercom/retrofit2/RequestBuilder;->formBuilder:Lio/intercom/okhttp3/FormBody$Builder;
    ...
    .line 68
    new-instance p1, Lio/intercom/okhttp3/MultipartBody$Builder;

    invoke-direct {p1}, Lio/intercom/okhttp3/MultipartBody$Builder;-><init>()V

    iput-object p1, p0, Lio/intercom/retrofit2/RequestBuilder;->multipartBuilder:Lio/intercom/okhttp3/MultipartBody$Builder;

    .line 69
    iget-object p1, p0, Lio/intercom/retrofit2/RequestBuilder;->multipartBuilder:Lio/intercom/okhttp3/MultipartBody$Builder;

    sget-object p2, Lio/intercom/okhttp3/MultipartBody;->FORM:Lio/intercom/okhttp3/MediaType;

    invoke-virtual {p1, p2}, Lio/intercom/okhttp3/MultipartBody$Builder;->setType(Lio/intercom/okhttp3/MediaType;)Lio/intercom/okhttp3/MultipartBody$Builder;
...
.method private static canonicalizeForPath(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 106
    invoke-virtual {v3, p0, v1, v2}, Lio/intercom/a/c;->a(Ljava/lang/String;II)Lio/intercom/a/c;

    .line 107
    invoke-static {v3, p0, v2, v0, p1}, Lio/intercom/retrofit2/RequestBuilder;->canonicalizeForPath(Lio/intercom/a/c;Ljava/lang/String;IIZ)V

    .line 108
    invoke-virtual {v3}, Lio/intercom/a/c;->r()Ljava/lang/String;
...
.method private static canonicalizeForPath(Lio/intercom/a/c;Ljava/lang/String;IIZ)V
    .locals 6
    ...
    .line 141
    :cond_1
    invoke-virtual {p0, v1}, Lio/intercom/a/c;->a(I)Lio/intercom/a/c;
    ...
    .line 132
    :cond_3
    invoke-virtual {v0, v1}, Lio/intercom/a/c;->a(I)Lio/intercom/a/c;
    ...
    .line 136
    sget-object v4, Lio/intercom/retrofit2/RequestBuilder;->HEX_DIGITS:[C
    ...
    invoke-virtual {p0, v4}, Lio/intercom/a/c;->b(I)Lio/intercom/a/c;
...
.method addFormField(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 169
    iget-object p3, p0, Lio/intercom/retrofit2/RequestBuilder;->formBuilder:Lio/intercom/okhttp3/FormBody$Builder;

    invoke-virtual {p3, p1, p2}, Lio/intercom/okhttp3/FormBody$Builder;->addEncoded(Ljava/lang/String;Ljava/lang/String;)Lio/intercom/okhttp3/FormBody$Builder;
    ...
    invoke-virtual {p3, p1, p2}, Lio/intercom/okhttp3/FormBody$Builder;->add(Ljava/lang/String;Ljava/lang/String;)Lio/intercom/okhttp3/FormBody$Builder;
...
.method addHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 83
    iput-object p1, p0, Lio/intercom/retrofit2/RequestBuilder;->contentType:Lio/intercom/okhttp3/MediaType;
...
.method addPart(Lio/intercom/okhttp3/Headers;Lio/intercom/okhttp3/RequestBody;)V
    .locals 1
...
.method addPart(Lio/intercom/okhttp3/MultipartBody$Part;)V
    .locals 1
...
.method addPathParam(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-object p1, p0, Lio/intercom/retrofit2/RequestBuilder;->relativeUrl:Ljava/lang/String;
...
.method addQueryParam(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 149
    iget-object v1, p0, Lio/intercom/retrofit2/RequestBuilder;->baseUrl:Lio/intercom/okhttp3/HttpUrl;

    invoke-virtual {v1, v0}, Lio/intercom/okhttp3/HttpUrl;->newBuilder(Ljava/lang/String;)Lio/intercom/okhttp3/HttpUrl$Builder;
    ...
    iget-object p3, p0, Lio/intercom/retrofit2/RequestBuilder;->baseUrl:Lio/intercom/okhttp3/HttpUrl;
    ...
    iget-object p3, p0, Lio/intercom/retrofit2/RequestBuilder;->relativeUrl:Ljava/lang/String;
    ...
    .line 159
    iget-object p3, p0, Lio/intercom/retrofit2/RequestBuilder;->urlBuilder:Lio/intercom/okhttp3/HttpUrl$Builder;

    invoke-virtual {p3, p1, p2}, Lio/intercom/okhttp3/HttpUrl$Builder;->addEncodedQueryParameter(Ljava/lang/String;Ljava/lang/String;)Lio/intercom/okhttp3/HttpUrl$Builder;
    ...
    invoke-virtual {p3, p1, p2}, Lio/intercom/okhttp3/HttpUrl$Builder;->addQueryParameter(Ljava/lang/String;Ljava/lang/String;)Lio/intercom/okhttp3/HttpUrl$Builder;

    :goto_1
    return-void
.end method

.method build()Lio/intercom/okhttp3/Request;
    .locals 5
    ...
    .line 208
    invoke-virtual {v2}, Lio/intercom/okhttp3/FormBody$Builder;->build()Lio/intercom/okhttp3/FormBody;
    ...
    .line 210
    invoke-virtual {v2}, Lio/intercom/okhttp3/MultipartBody$Builder;->build()Lio/intercom/okhttp3/MultipartBody;
    ...
    :cond_3
    :goto_1
    iget-object v2, p0, Lio/intercom/retrofit2/RequestBuilder;->contentType:Lio/intercom/okhttp3/MediaType;
    ...
    .line 220
    new-instance v3, Lio/intercom/retrofit2/RequestBuilder$ContentTypeOverridingRequestBody;

    invoke-direct {v3, v1, v2}, Lio/intercom/retrofit2/RequestBuilder$ContentTypeOverridingRequestBody;-><init>(Lio/intercom/okhttp3/RequestBody;Lio/intercom/okhttp3/MediaType;)V
    ...
    .line 222
    :cond_4
    iget-object v3, p0, Lio/intercom/retrofit2/RequestBuilder;->requestBuilder:Lio/intercom/okhttp3/Request$Builder;

    const-string v4, "Content-Type"

    invoke-virtual {v2}, Lio/intercom/okhttp3/MediaType;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v3, v4, v2}, Lio/intercom/okhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lio/intercom/okhttp3/Request$Builder;
...
.method setBody(Lio/intercom/okhttp3/RequestBody;)V
    .locals 0
