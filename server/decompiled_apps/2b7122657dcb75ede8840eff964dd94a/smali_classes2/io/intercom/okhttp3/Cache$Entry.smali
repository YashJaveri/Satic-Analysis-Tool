...
.method constructor <init>(Lio/intercom/a/s;)V
    .locals 8
    ...
    iput-object v1, p0, Lio/intercom/okhttp3/Cache$Entry;->url:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/intercom/okhttp3/Cache$Entry;->requestMethod:Ljava/lang/String;
    ...
    .line 546
    invoke-static {v0}, Lio/intercom/okhttp3/Cache;->readInt(Lio/intercom/a/e;)I
    ...
    invoke-virtual {v1, v5}, Lio/intercom/okhttp3/Headers$Builder;->addLenient(Ljava/lang/String;)Lio/intercom/okhttp3/Headers$Builder;
    ...
    iput-object v1, p0, Lio/intercom/okhttp3/Cache$Entry;->varyHeaders:Lio/intercom/okhttp3/Headers;
    ...
    invoke-static {v1}, Lio/intercom/okhttp3/internal/http/StatusLine;->parse(Ljava/lang/String;)Lio/intercom/okhttp3/internal/http/StatusLine;
    ...
    iput-object v2, p0, Lio/intercom/okhttp3/Cache$Entry;->protocol:Lio/intercom/okhttp3/Protocol;

    .line 554
    iget v2, v1, Lio/intercom/okhttp3/internal/http/StatusLine;->code:I

    iput v2, p0, Lio/intercom/okhttp3/Cache$Entry;->code:I

    .line 555
    iget-object v1, v1, Lio/intercom/okhttp3/internal/http/StatusLine;->message:Ljava/lang/String;

    iput-object v1, p0, Lio/intercom/okhttp3/Cache$Entry;->message:Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Lio/intercom/okhttp3/Headers$Builder;->addLenient(Ljava/lang/String;)Lio/intercom/okhttp3/Headers$Builder;
    ...
    invoke-virtual {v1, v2}, Lio/intercom/okhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lio/intercom/okhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 563
    sget-object v4, Lio/intercom/okhttp3/Cache$Entry;->SENT_MILLIS:Ljava/lang/String;

    invoke-virtual {v1, v4}, Lio/intercom/okhttp3/Headers$Builder;->removeAll(Ljava/lang/String;)Lio/intercom/okhttp3/Headers$Builder;

    .line 564
    sget-object v4, Lio/intercom/okhttp3/Cache$Entry;->RECEIVED_MILLIS:Ljava/lang/String;
    ...
    .line 567
    :goto_2
    iput-wide v6, p0, Lio/intercom/okhttp3/Cache$Entry;->sentRequestMillis:J
    ...
    .line 570
    :cond_3
    iput-wide v4, p0, Lio/intercom/okhttp3/Cache$Entry;->receivedResponseMillis:J
    ...
    iput-object v1, p0, Lio/intercom/okhttp3/Cache$Entry;->responseHeaders:Lio/intercom/okhttp3/Headers;
    ...
    .line 579
    invoke-static {v1}, Lio/intercom/okhttp3/CipherSuite;->forJavaName(Ljava/lang/String;)Lio/intercom/okhttp3/CipherSuite;

    move-result-object v1

    .line 580
    invoke-direct {p0, v0}, Lio/intercom/okhttp3/Cache$Entry;->readCertificateList(Lio/intercom/a/e;)Ljava/util/List;
    ...
    .line 590
    :goto_4
    invoke-interface {p1}, Lio/intercom/a/s;->close()V
...
.method private readCertificateList(Lio/intercom/a/e;)Ljava/util/List;
    .locals 6
    ...
    .line 658
    invoke-static {p1}, Lio/intercom/okhttp3/Cache;->readInt(Lio/intercom/a/e;)I
    ...
    .line 665
    invoke-interface {p1}, Lio/intercom/a/e;->s()Ljava/lang/String;
    ...
    .line 667
    invoke-static {v4}, Lio/intercom/a/f;->b(Ljava/lang/String;)Lio/intercom/a/f;

    move-result-object v4

    invoke-virtual {v5, v4}, Lio/intercom/a/c;->a(Lio/intercom/a/f;)Lio/intercom/a/c;

    .line 668
    invoke-virtual {v5}, Lio/intercom/a/c;->g()Ljava/io/InputStream;
...
.method private writeCertList(Lio/intercom/a/d;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lio/intercom/a/d;->n(J)Lio/intercom/a/d;
    ...
    .line 680
    invoke-interface {v0, v1}, Lio/intercom/a/d;->i(I)Lio/intercom/a/d;
    ...
    .line 683
    invoke-static {v3}, Lio/intercom/a/f;->a([B)Lio/intercom/a/f;

    move-result-object v3

    invoke-virtual {v3}, Lio/intercom/a/f;->b()Ljava/lang/String;

    move-result-object v3

    .line 684
    invoke-interface {p1, v3}, Lio/intercom/a/d;->b(Ljava/lang/String;)Lio/intercom/a/d;

    move-result-object v3

    .line 685
    invoke-interface {v3, v1}, Lio/intercom/a/d;->i(I)Lio/intercom/a/d;
    :try_end_0
...
# virtual methods
.method public matches(Lio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)Z
    .locals 2
...
.method public response(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Snapshot;)Lio/intercom/okhttp3/Response;
    .locals 5
    ...
    .line 713
    invoke-virtual {p1, v0}, Lio/intercom/okhttp3/Response$Builder;->handshake(Lio/intercom/okhttp3/Handshake;)Lio/intercom/okhttp3/Response$Builder;

    move-result-object p1

    iget-wide v0, p0, Lio/intercom/okhttp3/Cache$Entry;->sentRequestMillis:J

    .line 714
    invoke-virtual {p1, v0, v1}, Lio/intercom/okhttp3/Response$Builder;->sentRequestAtMillis(J)Lio/intercom/okhttp3/Response$Builder;

    move-result-object p1

    iget-wide v0, p0, Lio/intercom/okhttp3/Cache$Entry;->receivedResponseMillis:J

    .line 715
    invoke-virtual {p1, v0, v1}, Lio/intercom/okhttp3/Response$Builder;->receivedResponseAtMillis(J)Lio/intercom/okhttp3/Response$Builder;
...
.method public writeTo(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 608
    invoke-virtual {p1, v0}, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lio/intercom/a/r;
    ...
    invoke-interface {p1, v3, v4}, Lio/intercom/a/d;->n(J)Lio/intercom/a/d;
    ...
    invoke-virtual {v4, v3}, Lio/intercom/okhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v4

    invoke-interface {p1, v4}, Lio/intercom/a/d;->b(Ljava/lang/String;)Lio/intercom/a/d;
    ...
    .line 618
    invoke-interface {v4, v5}, Lio/intercom/a/d;->b(Ljava/lang/String;)Lio/intercom/a/d;
    ...
    .line 619
    invoke-virtual {v5, v3}, Lio/intercom/okhttp3/Headers;->value(I)Ljava/lang/String;
    ...
    .line 620
    invoke-interface {v4, v2}, Lio/intercom/a/d;->i(I)Lio/intercom/a/d;
    ...
    .line 629
    invoke-interface {v3, v4}, Lio/intercom/a/d;->b(Ljava/lang/String;)Lio/intercom/a/d;
    ...
    .line 631
    invoke-interface {v3, v2}, Lio/intercom/a/d;->i(I)Lio/intercom/a/d;
    ...
    invoke-interface {p1, v0}, Lio/intercom/a/d;->b(Ljava/lang/String;)Lio/intercom/a/d;
    ...
    iget-wide v3, p0, Lio/intercom/okhttp3/Cache$Entry;->sentRequestMillis:J
    ...
    iget-wide v3, p0, Lio/intercom/okhttp3/Cache$Entry;->receivedResponseMillis:J
    ...
    invoke-direct {p0, p1, v0}, Lio/intercom/okhttp3/Cache$Entry;->writeCertList(Lio/intercom/a/d;Ljava/util/List;)V
