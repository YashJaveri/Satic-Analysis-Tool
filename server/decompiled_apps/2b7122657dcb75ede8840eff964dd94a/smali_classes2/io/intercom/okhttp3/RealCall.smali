...
.method private constructor <init>(Lio/intercom/okhttp3/OkHttpClient;Lio/intercom/okhttp3/Request;Z)V
    ...
    .line 54
    new-instance p2, Lio/intercom/okhttp3/internal/http/RetryAndFollowUpInterceptor;

    invoke-direct {p2, p1, p3}, Lio/intercom/okhttp3/internal/http/RetryAndFollowUpInterceptor;-><init>(Lio/intercom/okhttp3/OkHttpClient;Z)V

    iput-object p2, p0, Lio/intercom/okhttp3/RealCall;->retryAndFollowUpInterceptor:Lio/intercom/okhttp3/internal/http/RetryAndFollowUpInterceptor;
...
.method static synthetic access$000(Lio/intercom/okhttp3/RealCall;)Lio/intercom/okhttp3/EventListener;
    ...
    .line 33
    iget-object p0, p0, Lio/intercom/okhttp3/RealCall;->eventListener:Lio/intercom/okhttp3/EventListener;
...
.method static newRealCall(Lio/intercom/okhttp3/OkHttpClient;Lio/intercom/okhttp3/Request;Z)Lio/intercom/okhttp3/RealCall;
    ...
    invoke-interface {p0, v0}, Lio/intercom/okhttp3/EventListener$Factory;->create(Lio/intercom/okhttp3/Call;)Lio/intercom/okhttp3/EventListener;

    move-result-object p0

    iput-object p0, v0, Lio/intercom/okhttp3/RealCall;->eventListener:Lio/intercom/okhttp3/EventListener;
...
.method public bridge synthetic clone()Lio/intercom/okhttp3/Call;
    .locals 1
...
.method public clone()Lio/intercom/okhttp3/RealCall;
    .locals 3
...
.method public enqueue(Lio/intercom/okhttp3/Callback;)V
    .locals 2
...
.method public execute()Lio/intercom/okhttp3/Response;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method getResponseWithInterceptorChain()Lio/intercom/okhttp3/Response;
    .locals 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v2, p0, Lio/intercom/okhttp3/RealCall;->client:Lio/intercom/okhttp3/OkHttpClient;

    invoke-virtual {v2}, Lio/intercom/okhttp3/OkHttpClient;->cookieJar()Lio/intercom/okhttp3/CookieJar;

    move-result-object v2

    invoke-direct {v0, v2}, Lio/intercom/okhttp3/internal/http/BridgeInterceptor;-><init>(Lio/intercom/okhttp3/CookieJar;)V
    ...
    invoke-virtual {v2}, Lio/intercom/okhttp3/OkHttpClient;->internalCache()Lio/intercom/okhttp3/internal/cache/InternalCache;

    move-result-object v2

    invoke-direct {v0, v2}, Lio/intercom/okhttp3/internal/cache/CacheInterceptor;-><init>(Lio/intercom/okhttp3/internal/cache/InternalCache;)V
    ...
    invoke-direct {v0, v2}, Lio/intercom/okhttp3/internal/connection/ConnectInterceptor;-><init>(Lio/intercom/okhttp3/OkHttpClient;)V
    ...
    invoke-direct {v0, v2}, Lio/intercom/okhttp3/internal/http/CallServerInterceptor;-><init>(Z)V

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 196
    new-instance v12, Lio/intercom/okhttp3/internal/http/RealInterceptorChain;
    ...
    .line 197
    invoke-virtual {v0}, Lio/intercom/okhttp3/OkHttpClient;->connectTimeoutMillis()I
    ...
    .line 198
    invoke-virtual {v0}, Lio/intercom/okhttp3/OkHttpClient;->readTimeoutMillis()I

    move-result v10

    iget-object v0, p0, Lio/intercom/okhttp3/RealCall;->client:Lio/intercom/okhttp3/OkHttpClient;

    invoke-virtual {v0}, Lio/intercom/okhttp3/OkHttpClient;->writeTimeoutMillis()I
    ...
    invoke-interface {v12, v0}, Lio/intercom/okhttp3/Interceptor$Chain;->proceed(Lio/intercom/okhttp3/Request;)Lio/intercom/okhttp3/Response;
...
.method streamAllocation()Lio/intercom/okhttp3/internal/connection/StreamAllocation;
    .locals 1
...
.method toLoggableString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lio/intercom/okhttp3/RealCall;->forWebSocket:Z
