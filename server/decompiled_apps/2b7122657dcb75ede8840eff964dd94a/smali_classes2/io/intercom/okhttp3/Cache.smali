...
.method constructor <init>(Ljava/io/File;JLio/intercom/okhttp3/internal/io/FileSystem;)V
    ...
    .line 183
    invoke-static/range {v1 .. v6}, Lio/intercom/okhttp3/internal/cache/DiskLruCache;->create(Lio/intercom/okhttp3/internal/io/FileSystem;Ljava/io/File;IIJ)Lio/intercom/okhttp3/internal/cache/DiskLruCache;

    move-result-object p1

    iput-object p1, p0, Lio/intercom/okhttp3/Cache;->cache:Lio/intercom/okhttp3/internal/cache/DiskLruCache;
...
.method public static key(Lio/intercom/okhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/intercom/a/f;->a(Ljava/lang/String;)Lio/intercom/a/f;

    move-result-object p0

    invoke-virtual {p0}, Lio/intercom/a/f;->c()Lio/intercom/a/f;

    move-result-object p0

    invoke-virtual {p0}, Lio/intercom/a/f;->f()Ljava/lang/String;
...
.method static readInt(Lio/intercom/a/e;)I
    .locals 5
    ...
    .line 722
    :try_start_0
    invoke-interface {p0}, Lio/intercom/a/e;->o()J

    move-result-wide v0

    .line 723
    invoke-interface {p0}, Lio/intercom/a/e;->s()Ljava/lang/String;
...
.method get(Lio/intercom/okhttp3/Request;)Lio/intercom/okhttp3/Response;
    .locals 4
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
    ...
    invoke-static {v0}, Lio/intercom/okhttp3/Cache;->key(Lio/intercom/okhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lio/intercom/okhttp3/internal/cache/DiskLruCache;->get(Ljava/lang/String;)Lio/intercom/okhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-virtual {v0, v3}, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lio/intercom/a/s;

    move-result-object v3

    invoke-direct {v2, v3}, Lio/intercom/okhttp3/Cache$Entry;-><init>(Lio/intercom/a/s;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    .line 211
    invoke-virtual {v2, v0}, Lio/intercom/okhttp3/Cache$Entry;->response(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Snapshot;)Lio/intercom/okhttp3/Response;

    move-result-object v0

    .line 213
    invoke-virtual {v2, p1, v0}, Lio/intercom/okhttp3/Cache$Entry;->matches(Lio/intercom/okhttp3/Request;Lio/intercom/okhttp3/Response;)Z
    ...
    invoke-static {p1}, Lio/intercom/okhttp3/internal/Util;->closeQuietly(Ljava/io/Closeable;)V
...
.method put(Lio/intercom/okhttp3/Response;)Lio/intercom/okhttp3/internal/cache/CacheRequest;
    .locals 3
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
    ...
    invoke-virtual {p0, p1}, Lio/intercom/okhttp3/Cache;->remove(Lio/intercom/okhttp3/Request;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 243
    :cond_2
    new-instance v0, Lio/intercom/okhttp3/Cache$Entry;

    invoke-direct {v0, p1}, Lio/intercom/okhttp3/Cache$Entry;-><init>(Lio/intercom/okhttp3/Response;)V

    .line 246
    :try_start_1
    iget-object v1, p0, Lio/intercom/okhttp3/Cache;->cache:Lio/intercom/okhttp3/internal/cache/DiskLruCache;
    ...
    invoke-static {p1}, Lio/intercom/okhttp3/Cache;->key(Lio/intercom/okhttp3/HttpUrl;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, p1}, Lio/intercom/okhttp3/internal/cache/DiskLruCache;->edit(Ljava/lang/String;)Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;
    ...
    :cond_3
    :try_start_2
    invoke-virtual {v0, p1}, Lio/intercom/okhttp3/Cache$Entry;->writeTo(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;)V

    .line 251
    new-instance v0, Lio/intercom/okhttp3/Cache$CacheRequestImpl;

    invoke-direct {v0, p0, p1}, Lio/intercom/okhttp3/Cache$CacheRequestImpl;-><init>(Lio/intercom/okhttp3/Cache;Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;)V
    :try_end_2
    ...
    .line 253
    :catch_2
    invoke-direct {p0, p1}, Lio/intercom/okhttp3/Cache;->abortQuietly(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;)V

    return-object v2
.end method

.method remove(Lio/intercom/okhttp3/Request;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1}, Lio/intercom/okhttp3/internal/cache/DiskLruCache;->remove(Ljava/lang/String;)Z
...
.method declared-synchronized trackResponse(Lio/intercom/okhttp3/internal/cache/CacheStrategy;)V
    .locals 1
    ...
    .line 407
    iget p1, p0, Lio/intercom/okhttp3/Cache;->networkCount:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Lio/intercom/okhttp3/Cache;->networkCount:I

    goto :goto_0

    .line 408
    :cond_0
    iget-object p1, p1, Lio/intercom/okhttp3/internal/cache/CacheStrategy;->cacheResponse:Lio/intercom/okhttp3/Response;

    if-eqz p1, :cond_1

    .line 410
    iget p1, p0, Lio/intercom/okhttp3/Cache;->hitCount:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Lio/intercom/okhttp3/Cache;->hitCount:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method update(Lio/intercom/okhttp3/Response;Lio/intercom/okhttp3/Response;)V
    .locals 1

    .line 263
    new-instance v0, Lio/intercom/okhttp3/Cache$Entry;

    invoke-direct {v0, p2}, Lio/intercom/okhttp3/Cache$Entry;-><init>(Lio/intercom/okhttp3/Response;)V
    ...
    check-cast p1, Lio/intercom/okhttp3/Cache$CacheResponseBody;

    iget-object p1, p1, Lio/intercom/okhttp3/Cache$CacheResponseBody;->snapshot:Lio/intercom/okhttp3/internal/cache/DiskLruCache$Snapshot;

    .line 267
    :try_start_0
    invoke-virtual {p1}, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Snapshot;->edit()Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 270
    invoke-virtual {p1}, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->commit()V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
