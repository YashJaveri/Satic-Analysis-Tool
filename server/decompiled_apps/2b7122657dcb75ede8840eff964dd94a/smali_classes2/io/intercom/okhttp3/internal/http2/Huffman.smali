...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/intercom/okhttp3/internal/http2/Huffman;->CODES:[I
...
.method private addCode(IIB)V
    ...
    invoke-direct {v0, p1, p3}, Lio/intercom/okhttp3/internal/http2/Huffman$Node;-><init>(II)V

    .line 175
    iget-object p1, p0, Lio/intercom/okhttp3/internal/http2/Huffman;->root:Lio/intercom/okhttp3/internal/http2/Huffman$Node;
    ...
    .line 179
    iget-object v2, p1, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->children:[Lio/intercom/okhttp3/internal/http2/Huffman$Node;
    ...
    invoke-direct {v3}, Lio/intercom/okhttp3/internal/http2/Huffman$Node;-><init>()V

    aput-object v3, v2, v1

    .line 185
    :cond_0
    iget-object p1, p1, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->children:[Lio/intercom/okhttp3/internal/http2/Huffman$Node;
...
.method private buildTree()V
    ...
    .line 168
    sget-object v2, Lio/intercom/okhttp3/internal/http2/Huffman;->CODES:[I

    aget v2, v2, v0

    aget-byte v1, v1, v0

    invoke-direct {p0, v0, v2, v1}, Lio/intercom/okhttp3/internal/http2/Huffman;->addCode(IIB)V
...
.method decode([B)[B
    ...
    .line 130
    iget-object v1, p0, Lio/intercom/okhttp3/internal/http2/Huffman;->root:Lio/intercom/okhttp3/internal/http2/Huffman$Node;
    ...
    .line 140
    iget-object v5, v4, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->children:[Lio/intercom/okhttp3/internal/http2/Huffman$Node;

    if-nez v5, :cond_0

    .line 142
    iget v5, v4, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->symbol:I

    invoke-virtual {v0, v5}, Ljava/io/ByteArrayOutputStream;->write(I)V

    .line 143
    iget v4, v4, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->terminalBits:I
    ...
    iget v2, p1, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->terminalBits:I
    ...
    .line 158
    :cond_3
    iget v2, p1, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->symbol:I

    invoke-virtual {v0, v2}, Ljava/io/ByteArrayOutputStream;->write(I)V

    .line 159
    iget p1, p1, Lio/intercom/okhttp3/internal/http2/Huffman$Node;->terminalBits:I
...
.method encode(Lio/intercom/a/f;Lio/intercom/a/d;)V
    .locals 8
    ...
    .line 96
    invoke-virtual {p1, v0}, Lio/intercom/a/f;->a(I)B
    ...
    .line 97
    sget-object v6, Lio/intercom/okhttp3/internal/http2/Huffman;->CODES:[I

    aget v6, v6, v4

    .line 98
    sget-object v7, Lio/intercom/okhttp3/internal/http2/Huffman;->CODE_LENGTHS:[B
    ...
    .line 106
    invoke-interface {p2, v4}, Lio/intercom/a/d;->i(I)Lio/intercom/a/d;
    ...
    .line 113
    invoke-interface {p2, p1}, Lio/intercom/a/d;->i(I)Lio/intercom/a/d;

    :cond_2
    return-void
.end method

.method encodedLength(Lio/intercom/a/f;)I
    .locals 5
    ...
    .line 121
    invoke-virtual {p1, v2}, Lio/intercom/a/f;->a(I)B
