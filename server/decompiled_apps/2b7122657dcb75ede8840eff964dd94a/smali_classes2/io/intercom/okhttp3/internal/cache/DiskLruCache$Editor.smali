...
.method constructor <init>(Lio/intercom/okhttp3/internal/cache/DiskLruCache;Lio/intercom/okhttp3/internal/cache/DiskLruCache$Entry;)V
    ...
    .line 838
    iget-boolean p2, p2, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Entry;->readable:Z
    ...
    :cond_0
    iget p1, p1, Lio/intercom/okhttp3/internal/cache/DiskLruCache;->valueCount:I

    new-array p1, p1, [Z

    :goto_0
    iput-object p1, p0, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->written:[Z
...
.method public abort()V
    ...
    .line 935
    :try_start_0
    iget-boolean v1, p0, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->done:Z

    if-nez v1, :cond_1

    .line 938
    iget-object v1, p0, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->entry:Lio/intercom/okhttp3/internal/cache/DiskLruCache$Entry;

    iget-object v1, v1, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Entry;->currentEditor:Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;
    ...
    invoke-virtual {v1, p0, v2}, Lio/intercom/okhttp3/internal/cache/DiskLruCache;->completeEdit(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;Z)V

    :cond_0
    const/4 v1, 0x1

    .line 941
    iput-boolean v1, p0, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->done:Z
...
.method public commit()V
    ...
    .line 925
    :cond_0
    iput-boolean v2, p0, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->done:Z
...
.method public newSink(I)Lio/intercom/a/r;
    .locals 3
    ...
    .line 891
    invoke-static {}, Lio/intercom/a/l;->a()Lio/intercom/a/r;
    ...
    iget-boolean v1, v1, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Entry;->readable:Z

    if-nez v1, :cond_1

    .line 894
    iget-object v1, p0, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;->written:[Z
    ...
    iget-object v1, v1, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Entry;->dirtyFiles:[Ljava/io/File;
    ...
    invoke-interface {v1, p1}, Lio/intercom/okhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lio/intercom/a/r;
    ...
    .line 903
    :try_start_2
    new-instance v1, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor$1;

    invoke-direct {v1, p0, p1}, Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor$1;-><init>(Lio/intercom/okhttp3/internal/cache/DiskLruCache$Editor;Lio/intercom/a/r;)V
...
.method public newSource(I)Lio/intercom/a/s;
    .locals 4
    ...
    invoke-interface {v1, p1}, Lio/intercom/okhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lio/intercom/a/s;
