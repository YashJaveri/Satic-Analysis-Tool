...
# direct methods
.method constructor <init>(IILio/intercom/a/s;)V
    .locals 1
    ...
    .line 127
    iput v0, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->headerCount:I
    ...
    .line 137
    invoke-static {p3}, Lio/intercom/a/l;->a(Lio/intercom/a/s;)Lio/intercom/a/e;

    move-result-object p1

    iput-object p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->source:Lio/intercom/a/e;

    return-void
.end method

.method constructor <init>(ILio/intercom/a/s;)V
    .locals 0

    .line 131
    invoke-direct {p0, p1, p1, p2}, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;-><init>(IILio/intercom/a/s;)V
...
.method private evictToRecoverBytes(I)I
    ...
    .line 172
    :cond_0
    iget-object p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->dynamicTable:[Lio/intercom/okhttp3/internal/http2/Header;
    ...
    iget v3, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->headerCount:I

    invoke-static {p1, v2, p1, v1, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 174
    iget p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->nextHeaderIndex:I

    add-int/2addr p1, v0

    iput p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->nextHeaderIndex:I

    :cond_1
    return v0
.end method

.method private getName(I)Lio/intercom/a/f;
    .locals 2
    ...
    iget-object p1, p1, Lio/intercom/okhttp3/internal/http2/Header;->name:Lio/intercom/a/f;
...
.method private insertIntoDynamicTable(ILio/intercom/okhttp3/internal/http2/Header;)V
    ...
    .line 289
    :cond_1
    iget v3, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->dynamicTableByteCount:I
    ...
    .line 290
    invoke-direct {p0, v3}, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->evictToRecoverBytes(I)I
    ...
    .line 293
    iget p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->headerCount:I
    ...
    new-array p1, p1, [Lio/intercom/okhttp3/internal/http2/Header;
    ...
    iput v1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->nextHeaderIndex:I

    .line 297
    iput-object p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->dynamicTable:[Lio/intercom/okhttp3/internal/http2/Header;
    ...
    iput p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->headerCount:I
    ...
    .line 306
    :goto_0
    iget p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->dynamicTableByteCount:I

    add-int/2addr p1, v0

    iput p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->dynamicTableByteCount:I
...
.method private readByte()I
    ...
    .line 310
    iget-object v0, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->source:Lio/intercom/a/e;
...
.method private readIndexedHeader(I)V
    ...
    .line 227
    iget-object p1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->headerList:Ljava/util/List;
...
.method private readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 250
    invoke-direct {p0, p1}, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->getName(I)Lio/intercom/a/f;

    move-result-object p1

    .line 251
    invoke-virtual {p0}, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->readByteString()Lio/intercom/a/f;
    ...
    invoke-direct {v1, p1, v0}, Lio/intercom/okhttp3/internal/http2/Header;-><init>(Lio/intercom/a/f;Lio/intercom/a/f;)V

    const/4 p1, -0x1

    invoke-direct {p0, p1, v1}, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->insertIntoDynamicTable(ILio/intercom/okhttp3/internal/http2/Header;)V
...
.method private readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-static {v0}, Lio/intercom/okhttp3/internal/http2/Hpack;->checkLowercase(Lio/intercom/a/f;)Lio/intercom/a/f;
    ...
    invoke-direct {v2, v0, v1}, Lio/intercom/okhttp3/internal/http2/Header;-><init>(Lio/intercom/a/f;Lio/intercom/a/f;)V

    const/4 v0, -0x1

    invoke-direct {p0, v0, v2}, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->insertIntoDynamicTable(ILio/intercom/okhttp3/internal/http2/Header;)V
...
.method private readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lio/intercom/okhttp3/internal/http2/Header;-><init>(Lio/intercom/a/f;Lio/intercom/a/f;)V
...
.method private readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lio/intercom/okhttp3/internal/http2/Header;-><init>(Lio/intercom/a/f;Lio/intercom/a/f;)V
...
.method readByteString()Lio/intercom/a/f;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 339
    invoke-virtual {p0, v0, v2}, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->readInt(II)I
    ...
    iget-object v2, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->source:Lio/intercom/a/e;

    int-to-long v3, v0

    invoke-interface {v2, v3, v4}, Lio/intercom/a/e;->h(J)[B

    move-result-object v0

    invoke-virtual {v1, v0}, Lio/intercom/okhttp3/internal/http2/Huffman;->decode([B)[B

    move-result-object v0

    invoke-static {v0}, Lio/intercom/a/f;->a([B)Lio/intercom/a/f;
    ...
    .line 344
    :cond_1
    iget-object v1, p0, Lio/intercom/okhttp3/internal/http2/Hpack$Reader;->source:Lio/intercom/a/e;

    int-to-long v2, v0

    invoke-interface {v1, v2, v3}, Lio/intercom/a/e;->d(J)Lio/intercom/a/f;
