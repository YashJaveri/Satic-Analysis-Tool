...
.method static constructor <clinit>()V
    ...
    .line 126
    new-array v1, v0, [Lio/intercom/okhttp3/Protocol;

    sget-object v2, Lio/intercom/okhttp3/Protocol;->HTTP_2:Lio/intercom/okhttp3/Protocol;

    const/4 v3, 0x0

    aput-object v2, v1, v3

    sget-object v2, Lio/intercom/okhttp3/Protocol;->HTTP_1_1:Lio/intercom/okhttp3/Protocol;
    ...
    sput-object v1, Lio/intercom/okhttp3/OkHttpClient;->DEFAULT_PROTOCOLS:Ljava/util/List;

    .line 129
    new-array v0, v0, [Lio/intercom/okhttp3/ConnectionSpec;
...
.method constructor <init>(Lio/intercom/okhttp3/OkHttpClient$Builder;)V
    ...
    check-cast v3, Lio/intercom/okhttp3/ConnectionSpec;

    if-nez v2, :cond_1

    .line 245
    invoke-virtual {v3}, Lio/intercom/okhttp3/ConnectionSpec;->isTls()Z
    ...
    .line 270
    iget p1, p1, Lio/intercom/okhttp3/OkHttpClient$Builder;->pingInterval:I

    iput p1, p0, Lio/intercom/okhttp3/OkHttpClient;->pingInterval:I

    .line 272
    iget-object p1, p0, Lio/intercom/okhttp3/OkHttpClient;->interceptors:Ljava/util/List;
    ...
    .line 275
    iget-object p1, p0, Lio/intercom/okhttp3/OkHttpClient;->networkInterceptors:Ljava/util/List;
    ...
    iget-object v1, p0, Lio/intercom/okhttp3/OkHttpClient;->networkInterceptors:Ljava/util/List;
    ...
    iget-object v1, p0, Lio/intercom/okhttp3/OkHttpClient;->interceptors:Ljava/util/List;
